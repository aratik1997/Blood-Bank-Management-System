...
public class req_g extends JFrame implements ActionListener
{
	...
	public void actionPerformed(ActionEvent e) 
	{
		...
		if(e.getSource()==Submit)
		{
			...
			{
				this.dispose();
				req_list1 frame = new req_list1("A+.txt");
				frame.setVisible(true);
				frame.setFocusable(false);
				frame.setResizable(false);
			}
			...
			{
				this.dispose();
				req_list1 frame = new req_list1("B+.txt");
				frame.setVisible(true);
				frame.setFocusable(false);
				frame.setResizable(false);
			}
			...
			{
				this.dispose();
				req_list1 frame = new req_list1("O+.txt");
				frame.setVisible(true);
				frame.setFocusable(false);
				frame.setResizable(false);
			}
			...
			{
				this.dispose();
				req_list1 frame = new req_list1("AB+.txt");
				frame.setVisible(true);
				frame.setFocusable(false);
				frame.setResizable(false);
			}
